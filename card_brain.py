...
class CardBrain:
  ...
  def __init__(self):
    ...
    home_button = Button(image=home_img, command=self.home_page(), highlightthickness=0, bd=0)
    home_button.grid(column=3, row=0, pady=20)
  ...
  def front_card(self, stack, first_run=False):
    ...
    self.button_need_review.grid(column=0, row=9)
    self.button_remembered.grid(column=3, row=9)
